...
from donations.views import DonorProfileDetailView, GetAllDonorProfilesView, CreateBloodDonationView, \
    ...
    DonationScheduleCreationView, DonationScheduleDetailView
...
urlpatterns = [
    ...
    path('scheduledonation/', DonationScheduleCreationView.as_view()),
    path('scheduledonation/<int:id>/', DonationScheduleDetailView.as_view()),
